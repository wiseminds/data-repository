...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Post&&(identical(other.userId, _this.userId) || other.userId == _this.userId)&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.title, _this.title) || other.title == _this.title)&&(identical(other.body, _this.body) || other.body == _this.body));
}
...
int get hashCode {
  final _this = this as Post;
  return Object.hash(runtimeType,_this.userId,_this.id,_this.title,_this.body);
}

@override
String toString() {
  final _this = this as Post;
  return 'Post(userId: ${_this.userId}, id: ${_this.id}, title: ${_this.title}, body: ${_this.body})';
}
...
/// Create a copy of Post
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = freezed,Object? id = null,Object? title = null,Object? body = freezed,}) {
  return _then(Post(
...
/// Create a copy of Post
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = freezed,Object? id = null,Object? title = null,Object? body = freezed,}) {
  return _then(_Post(
userId: freezed == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as int?,id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
